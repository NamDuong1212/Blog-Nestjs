...
export class WalletController {
  ...
  @ApiOperation({
    ...
    description:
      'Creator request withdrawal via PayPal with JWT authentication.',
  })
  @ApiResponse({
    status: 200,
  ...
  @Post('force-check/:withdrawalId')
  @UseGuards(JwtAuthGuard)
  async forceCheckWithdrawal(@Param('withdrawalId') withdrawalId: string) {
    return this.walletService.forceCheckWithdrawal(withdrawalId);
  }
}
